...
export function runMonitor() {
  ...
  console.log('');
  console.log(`  ${paint.green('✓')} External exposure detection`);
  console.log(`    ${paint.dim('We check your instance from outside your network.')}`);
  ...
  console.log('');
  console.log(`  ${paint.bold('Get started:')}  ${paint.cyan('clawarmor.dev/monitor')}`);
  console.log('');
  console.log(HR);
  console.log('');
  console.log(`  ${paint.dim('Questions? hello@clawarmor.dev')}`);
  console.log('');
}
